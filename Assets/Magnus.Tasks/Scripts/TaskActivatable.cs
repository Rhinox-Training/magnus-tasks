...
public class TaskActivatable : MonoBehaviour
{
    ...
    protected bool HasRegionData => !Always &&
                                  ((!SceneTask && (!StartStepIndex.IsNullOrEmpty() || !EndStepIndex.IsNullOrEmpty())) ||
    ...
    [FoldoutContainer("Debug"), ShowReadOnlyInPlayMode] private BaseStep _currentStart;
    [FoldoutContainer("Debug"), ShowReadOnlyInPlayMode] private BaseStep _currentEnd;
