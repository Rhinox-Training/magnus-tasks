...
namespace Rhinox.Magnus.Tasks
{
    ...
    public class DataViewer<T> : ArgumentDataContainer
    {
        ...
        [OnValueChanged(nameof(ValueChanged))] public T SmartData;
    ...
    {
        [OnValueChanged(nameof(ValueChanged))] [ValueReference(nameof(TargetType), "GUID")]
        public SerializableGuid GUID;

        [HideInInspector] public Type TargetType;
    ...
    public class DynamicMethodArgument : ISerializationCallbackReceiver, IUseReferenceGuid
    {
        ...
        [SerializeField, HideInInspector] private SerializableType _containerType;
