...
namespace Rhinox.Magnus.Tasks.Editor
{
    public static class TaskViewerSettings
    {
        public class TypeSettings
        {
            ...
            {
                return _type.GetMembers(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public |
    ...
    public class TaskViewerSettingsUI : PagerPage
    {
        ...
        protected override void OnDraw()
        {
            EditorGUILayout.HelpBox(
                "Types below will be fetched on the Step object and shown in the viewer. The fields define what can be used to search.",
                MessageType.Info);
